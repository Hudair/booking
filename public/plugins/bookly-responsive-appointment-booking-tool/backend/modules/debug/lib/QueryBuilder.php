    ...
    public static function getColumnData( $table, $column )
    {
        ...
        */
        ...
        $data = array(
            ...
            'bookly_appointments.online_meeting_provider' => array( 'type' => "enum('zoom','google_meet')", 'is_nullabe' => 1, 'extra' => '', 'default' => null, 'key' => '' ),
            ...
            'bookly_services.online_meetings' => array( 'type' => "enum('off','zoom','google_meet')", 'is_nullabe' => 0, 'extra' => '', 'default' => 'off', 'key' => '' ),
