...
class BooklyGoogle_Service_Calendar_Event extends BooklyGoogle_Collection
{
  ...
  public $colorId;
  protected $conferenceDataType = 'BooklyGoogle_Service_ConferenceData';
...
/**************************************************************************
 * Conference data from API v0.211.0                                      *
 * https://github.com/googleapis/google-api-php-client-services           *
 **************************************************************************/
class BooklyGoogle_Service_ConferenceData extends BooklyGoogle_Collection
{
    protected $collection_key = 'entryPoints';
    public $conferenceId;
    protected $conferenceSolutionType = 'BooklyGoogle_Service_ConferenceSolution';
    protected $conferenceSolutionDataType = '';
    protected $createRequestType = 'BooklyGoogle_Service_CreateConferenceRequest';
    protected $createRequestDataType = '';
    protected $entryPointsType = 'BooklyGoogle_Service_EntryPoint';
    protected $entryPointsDataType = 'array';
    public $notes;
    protected $parametersType = 'BooklyGoogle_Service_ConferenceParameters';
    ...
    /**
     * @param BooklyGoogle_Service_ConferenceSolution
     */
    public function setConferenceSolution( BooklyGoogle_Service_ConferenceSolution $conferenceSolution )
    {
        $this->conferenceSolution = $conferenceSolution;
    }

    /**
     * @return  BooklyGoogle_Service_ConferenceSolution
     */
    ...
    /**
     * @param BooklyGoogle_Service_CreateConferenceRequest
     */
    public function setCreateRequest( BooklyGoogle_Service_CreateConferenceRequest $createRequest )
    {
        $this->createRequest = $createRequest;
    }

    /**
     * @return BooklyGoogle_Service_CreateConferenceRequest
     */
    ...
    /**
     * @param BooklyGoogle_Service_EntryPoint[]
     */
    ...
    /**
     * @return BooklyGoogle_Service_EntryPoint[]
     */
    ...
    /**
     * @param BooklyGoogle_Service_ConferenceParameters
     */
    public function setParameters( BooklyGoogle_Service_ConferenceParameters $parameters )
    {
        $this->parameters = $parameters;
    }

    /**
     * @return BooklyGoogle_Service_ConferenceParameters
     */
...
class BooklyGoogle_Service_CreateConferenceRequest extends BooklyGoogle_Model
{
    protected $conferenceSolutionKeyType = "BooklyGoogle_Service_ConferenceSolutionKey";
    protected $conferenceSolutionKeyDataType = '';
    public $requestId;
    protected $statusType = 'BooklyGoogle_Service_ConferenceRequestStatus';
    protected $statusDataType = '';

    /**
     * @param BooklyGoogle_Service_ConferenceSolutionKey
     */
    public function setConferenceSolutionKey( BooklyGoogle_Service_ConferenceSolutionKey $conferenceSolutionKey )
    {
        $this->conferenceSolutionKey = $conferenceSolutionKey;
    }

    /**
     * @return BooklyGoogle_Service_ConferenceSolutionKey
     */
    ...
    /**
     * @param BooklyGoogle_Service_ConferenceRequestStatus
     */
    public function setStatus( BooklyGoogle_Service_ConferenceRequestStatus $status )
    {
        $this->status = $status;
    }

    /**
     * @return BooklyGoogle_Service_ConferenceRequestStatus
     */
    public function getStatus()
    {
        return $this->status;
...
class BooklyGoogle_Service_ConferenceSolutionKey extends BooklyGoogle_Model
{
    public $type;
...
class BooklyGoogle_Service_ConferenceRequestStatus extends BooklyGoogle_Model
{
    public $statusCode;
...
class BooklyGoogle_Service_ConferenceParameters extends BooklyGoogle_Model
{
    protected $addOnParametersType = 'BooklyGoogle_Service_ConferenceParametersAddOnParameters';
    protected $addOnParametersDataType = '';

    /**
     * @param BooklyGoogle_Service_ConferenceParametersAddOnParameters
     */
    public function setAddOnParameters( BooklyGoogle_Service_ConferenceParametersAddOnParameters $addOnParameters )
    {
        $this->addOnParameters = $addOnParameters;
    }

    /**
     * @return BooklyGoogle_Service_ConferenceParametersAddOnParameters
     */
...
class BooklyGoogle_Service_ConferenceParametersAddOnParameters extends BooklyGoogle_Model
{
    public $parameters;
...
class BooklyGoogle_Service_EntryPoint extends BooklyGoogle_Collection
{
